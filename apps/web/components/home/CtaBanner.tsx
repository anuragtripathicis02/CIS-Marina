...
export const CtaBanner = () => {
  return (
    <section className="py-20 bg-gradient-to-r from-navy-900 via-navy-800 to-navy-900 border-t border-slate-800 text-white text-center relative overflow-hidden">
      {/* Glow Accent */}
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 space-y-6">
        ...
        <div className="pt-4 flex flex-col sm:flex-row items-center justify-center gap-4">
          ...
          <Link
            href="/contact"
            className="w-full sm:w-auto px-8 py-4 rounded-xl bg-navy-950 hover:bg-navy-900 border border-slate-700 text-white font-semibold text-base transition-all"
          >
            Talk to an Expert
          </Link>
        </div>
